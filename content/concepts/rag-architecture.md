...
Indexing: {
  ...
  Doc -> Loader -> Chunker -> Embedder -> VS
}

Querying: {
  label: "在线查询阶段 (Querying)"
  Query: "用户查询"
  QT: "Query Transform\n查询转换"
  Retriever: "Retriever\n检索器"
  Reranker: "Reranker\n重排序"
  Generator: "Generator\n生成器"
  Response: "响应"
  Query -> QT -> Retriever -> Reranker -> Generator -> Response
}

Indexing.VS -> Querying.Retriever
```
...
Q1: "Q1: asyncio 性能特点"
Q2: "Q2: threading 性能特点"
Q3: "Q3: Python 并发模型比较"
Merge: "分别检索 → 合并结果"

Orig -> Q1: "Multi-Query 改写"
Orig -> Q2
Orig -> Q3
Q1 -> Merge
Q2 -> Merge
