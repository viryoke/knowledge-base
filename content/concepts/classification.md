...
```mermaid
graph TD
    Start(("开始")) --> step1["1. 数据准备<br/>特征工程 + 标签标注"]
    step1 --> step2["2. 模型选择<br/>逻辑回归 / SVM / 神经网络 / 决策树"]
    step2 --> step3["3. 定义损失函数<br/>Cross-Entropy Loss"]
    step3 --> step4["4. 训练优化<br/>梯度下降最小化损失"]
    step4 --> step5["5. 评估验证<br/>Confusion Matrix / F1 / AUC"]
    step5 --> step6["6. 正则化<br/>防止过拟合，提升泛化"]
    step6 --> End(("结束"))
```
